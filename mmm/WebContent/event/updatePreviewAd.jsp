...
<!-- 				</div> -->
			...
			<div class="col">
				...
				<input placeholder="Selected date" type="text" name="previewStartDate" class="form-control datepicker"  value="${preview.preStDate}">                    
					<div class="input-group-addon pinkstyle ml-1">
                	<i class="far fa-calendar-alt"></i>
              		</div>			
				</div>	
				...
				<td><div class='input-group date' data-provide="datepicker">
				 <input placeholder="Selected date" type="text" name="previewEndDate" class="form-control datepicker"  value="${preview.preEdDate}">                    
				 <div class="input-group-addon pinkstyle ml-1">
                  <i class="far fa-calendar-alt"></i>
           		  </div>			
				</div>
				...
				<td><div class='input-group date' data-provide="datepicker">
				 <input placeholder="Selected date" type="text" name="winnerDate" class="form-control col-md-5 col-xs-5 datepicker"  value="${preview.winDate}">                    
				 <div class="input-group-addon pinkstyle ml-1">
		          <i class="far fa-calendar-alt"></i>
		       	  </div>			
				  </div></td>
